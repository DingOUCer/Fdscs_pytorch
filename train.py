...
# train kitti
parser.add_argument('--lrepochs', type=str, default='300,400:10',help='the epochs to decay lr: the downscale rate')
parser.add_argument('--logdir', default='./checkpoints/kitti/fdscs_quant500', help='the directory to save logs and checkpoints')
parser.add_argument('--loadckpt', default='./checkpoints/sceneflow/fdscsdebug2/checkpoint_000075.ckpt',help='load the weights from a specific checkpoint,')
